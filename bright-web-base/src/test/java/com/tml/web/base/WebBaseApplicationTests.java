...
import com.tml.web.base.interceptor.InterceptorProperties;
import com.tml.web.base.mail.dto.MailDto;
import com.tml.web.base.mail.service.MailService;
...
public class WebBaseApplicationTests {
    ...
    public void getUploadProperties() {
        if (!interceptorProperties.getUpload().getAllowFileExtensions().isEmpty()) {
            interceptorProperties.getUpload().getAllowFileExtensions().forEach(System.out::println);
        } else {
    ...
    public void testPassword() {
        ...
        System.out.println(SecureUtil.md5(temp));
