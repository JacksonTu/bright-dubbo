...
import com.tml.api.notice.service.ISysNoticeService;
...
public class SysNoticeController {
    ...
    public CommonResult listSysNotice(com.tml.api.notice.dto.NoticeDTO noticeDto) {
        return CommonResult.success(sysNoticeService.listSysNotice(noticeDto));
    }

    @GetMapping("list")
    @SaCheckPermission("notice/list")
    public CommonResult pageSysNotice(com.tml.api.notice.dto.NoticeDTO noticeDto) {
    ...
    @SaCheckPermission("notice/release")
    ...
    @SaCheckPermission("notice/revoke")
    ...
    public CommonResult listNoticeByUser() {
        ...
        com.tml.api.notice.dto.NoticeDTO noticeDto = new com.tml.api.notice.dto.NoticeDTO();
